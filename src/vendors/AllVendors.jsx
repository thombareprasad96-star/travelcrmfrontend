...
// src/components/Vendors/Vendors.jsx  (UPDATED)
// ─────────────────────────────────────────────────────────────
// Changes vs original:
//  1. Edit popup (VendorFormModal) → navigate to /EditVendor/:id
//  2. View modal (ViewModal) → full data from backend on open
//  3. All edit buttons (table row + mobile card) → navigate
//  4. Toast pattern kept identical (inline custom Toast)
// ─────────────────────────────────────────────────────────────
