// // src/components/Leads/LeadLogs.jsx
// // ─────────────────────────────────────────────────────────────
// // Lead Logs Page — Travel CRM
// // Matches CRM design system perfectly
// // Reference: company/leads/view_logs.php?lead_id=123&name=Pratik screenshot
// // Features:
// //   - "Logs for Lead: {Name}" header with Add Log + Back to Leads + Back to All Logs buttons
// //   - Desktop table: Date | Stage | Log Comment | Follow-up Date | Added By
// //   - Add Log modal (with stage dropdown, comment textarea, follow-up date)
// //   - Mobile cards (responsive)
// //   - Stage color badges matching CRM
...
//   {
//     id: 2,
//     date: "Jun 03, 2026 10:15",
//     stage: "Contacted",
//     comment: "Client called back. Interested in Nepal package for 5 nights. Will confirm budget.",
//     followUpDate: "Jun 05, 2026",
//     addedBy: "Shreyash Raghvendra Shahi (Staff)",
//   },
//   {
//     id: 3,
//     date: "Jun 06, 2026 09:45",
//     stage: "Follow Up",
//     comment: "Sent itinerary via WhatsApp. Awaiting confirmation from client.",
...
//   useEffect(() => {
//     setLoading(true);
//     // BACKEND: leadLogsService.getLogs(id).then(res => setLogs(res.data)).finally(...)
//     const t = setTimeout(() => { setLogs(MOCK_LOGS); setLoading(false); }, 600);
//     return () => clearTimeout(t);
//   }, [id]);
