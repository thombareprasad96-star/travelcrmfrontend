    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
      ...
      <div className="p-6 space-y-3">
                ...
                <div className="sm:col-span-1">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full pl-3 pr-7 py-2 rounded-lg border border-slate-200 bg-white text-sm text-slate-700
                  ...
                  {cities.length > 0 ? (
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white text-sm text-slate-700
                        focus:border-indigo-400 focus:ring-2 focus:ring-indigo-50 outline-none transition-all placeholder-slate-400"
                    />
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 text-center px-2 py-2 rounded-lg border border-slate-200 bg-white text-sm font-semibold text-slate-700
                        focus:border-indigo-400 focus:ring-2 focus:ring-indigo-50 outline-none transition-all"
                    />
                    <button
                      type="button"
        ...
        {itinerary.length > 0 && (
          <div className="flex items-center justify-between px-4 py-2.5 bg-indigo-50 rounded-xl border border-indigo-100">
            ...
            <span className="text-sm font-bold text-indigo-700">
              {itinerary.reduce((sum, r) => sum + (r.nights || 1), 0)} Nights / {itinerary.reduce((sum, r) => sum + (r.nights || 1), 0) + 1} Days
            </span>
          </div>
        )}
        ...
        <button
          type="button"
          onClick={onAdd}
          className="w-full py-2.5 rounded-xl border-2 border-dashed border-indigo-300 hover:border-indigo-400 hover:bg-indigo-50
            text-indigo-600 font-semibold text-sm flex items-center justify-center gap-2 transition-all group"
        >
