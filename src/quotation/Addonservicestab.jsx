...
//       type: "", description: "", price: "", qty: 1, included: true,
//     };
//   }

//   // ── Har state change pe parent ko data do ────────────────
//   // Parent expects: { items: [...] }
//   // Each item: { serviceType, description, quantity, pricePerUnit }
//   useEffect(() => {
//     const items = services.map(s => ({
//       serviceType  : s.type        || "",
//       description  : s.description || "",
//       quantity     : Number(s.qty)   || 1,
//       pricePerUnit : Number(s.price) || 0,
//       included     : s.included,
//     }));
//     const total = services.reduce(
//       (acc, s) => acc + (Number(s.price) * Number(s.qty) || 0), 0
//     );
//     onDataChange?.({ items, amount: total });
//   }, [services]);
...
//             desc="Add extra services to the quotation."
//             onAdd={add}
...
//                       value={
//                         s.price && s.qty
//                           ? `₹${(Number(s.price) * Number(s.qty)).toLocaleString("en-IN")}`
//                           : "—"
//                       }
//                       disabled
//                     />
