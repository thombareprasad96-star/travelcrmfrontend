...
export default function CreateQuotation() {
  ...
  // itinerary: [{destination:"Dubai", nights:2}, {destination:"Manali", nights:2}, ...]
  ...
  const { dayCityMap, destinations: cityStays } = (() => {
    ...
    itin.forEach((item) => {
      ...
      const startDay = day;
      for (let i = 0; i < Math.max(nights, 1); i++) { map[day] = item.destination; day++; }
      const endDay = day - 1;
      stays.push({
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden fade-up"
          ...
          <div className="relative overflow-hidden">
            <div style={{ minHeight: 260 }}>
              ...
              <div style={{ display: activeTab === "hotel"       ? "block" : "none" }} className="p-3 sm:p-5 lg:p-6"><HotelTab                onDataChange={setHotelData}       paxInfo={paxInfo} destinations={cityStays} /></div>
              <div style={{ display: activeTab === "sightseeing" ? "block" : "none" }} className="p-3 sm:p-5 lg:p-6"><SightseeingTab          onDataChange={setSightseeingData} paxInfo={paxInfo} dayCityMap={dayCityMap} /></div>
