...
//   useEffect(() => {
//     onDataChange?.({ included, title, amount, cruises });
//   }, [included, title, amount, cruises]);

//   // ── Helpers ───────────────────────────────────────────────
//   const add    = () => setCruises(p => [...p, newCruise()]);
//   const remove = (id) => setCruises(p => p.filter(c => c.id !== id));
//   const update = (id, k, v) =>
//     setCruises(p => p.map(c => c.id === id ? { ...c, [k]: v } : c));
...
//             label="Include Cruise in Quotation"
//           />
//           {included && (
//             <FieldGrid cols={2}>
//               <div>
...
//                 <FieldGrid cols={2}>
//                   <div>
//                     <Label required>Cruise Name</Label>
//                     <Input
//                       value={c.name}
//                       onChange={e => update(c.id, "name", e.target.value)}
//                       placeholder="e.g. Royal Caribbean Explorer"
//                     />
//                   </div>
//                   <div>
...
//                     <Input
//                       value={c.depPort}
//                       onChange={e => update(c.id, "depPort", e.target.value)}
...
//                     <Input
//                       value={c.arrPort}
//                       onChange={e => update(c.id, "arrPort", e.target.value)}
//                       placeholder="e.g. Goa"
//                     />
//                   </div>
//                 </FieldGrid>
...
//                       type="date"
//                       value={c.depDate}
//                       onChange={e => update(c.id, "depDate", e.target.value)}
//                     />
//                   </div>
//                   <div>
//                     <Label>Nights</Label>
...
//                       type="number"
//                       value={c.nights}
//                       onChange={e => update(c.id, "nights", e.target.value)}
//                       placeholder="e.g. 5"
//                     />
//                   </div>
//                   <div>
...
//                       options={CABIN_CATS}
//                       value={c.cabin}
//                       onChange={e => update(c.id, "cabin", e.target.value)}
//                     />
//                   </div>
//                 </FieldGrid>
...
//         <EmptyState
//           icon={Anchor}
//           title="No Cruise Added"
//           desc="Enable cruise above to add cruise details."
//         />
//       )}
