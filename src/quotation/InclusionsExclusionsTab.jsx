...
// import { Label, Input, SectionCard, RichText } from "./ui";
...
//               className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-xl transition-all flex-shrink-0 flex items-center gap-1.5">
//               <Plus size={15} /> Add
//             </button>
//           </div>
//           <div>
...
//             <button onClick={addExc}
//               className="px-4 py-2.5 bg-rose-600 hover:bg-rose-700 text-white text-sm font-bold rounded-xl transition-all flex-shrink-0 flex items-center gap-1.5">
//               <Plus size={15} /> Add
//             </button>
//           </div>
//           <div>
...
export default function InclusionsExclusionsTab({ onDataChange }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard title="Payment Policies" icon={CreditCard} iconColor="text-blue-600"
        headerRight={
      ...
      <SectionCard title="Cancellation Policies" icon={AlertTriangle} iconColor="text-amber-600"
        headerRight={
      ...
      <SectionCard title="Booking Terms & Conditions" icon={FileText} iconColor="text-slate-600"
        headerRight={
