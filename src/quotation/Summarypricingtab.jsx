...
//         style={{ background: "linear-gradient(135deg, #00c6a7 0%, #00a389 40%, #007d6b 100%)" }}
//       >
//         <div className="absolute -top-9 -right-8 w-32 h-32 rounded-full pointer-events-none"
//           style={{ background: "rgba(255,255,255,0.13)" }} />
//         <div className="absolute bottom-[-20px] right-10 w-24 h-24 rounded-full pointer-events-none"
//           style={{ background: "rgba(255,255,255,0.09)" }} />
//         <div className="absolute top-5 right-[80px] w-12 h-12 rounded-full pointer-events-none"
//           style={{ background: "rgba(255,255,255,0.07)" }} />
...
//         <div className="relative z-10 mt-4">
//           <p className="text-[10px] font-semibold uppercase tracking-[.13em]"
//             style={{ color: "rgba(255,255,255,0.72)" }}>
//             Final Quotation Total
//           </p>
//           <p className="text-[38px] font-extrabold text-white leading-none tracking-tight mt-1">
