...
// src/services/profilecreateUserService.js
// ─────────────────────────────────────────────────────────────
// Create User page — API service.
// Backend: POST /api/users { name, email, password, role, phoneNumber }.
// A tenant admin may only create MANAGER / TRAVEL_AGENT (see LABEL_TO_ROLE).
// ─────────────────────────────────────────────────────────────
