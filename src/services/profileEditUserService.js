...
// src/services/profileEditUserService.js
// ─────────────────────────────────────────────────────────────
// Edit User page — API service.
// Backend: PUT /api/users/{publicId} updates name/role/phone/isActive only
// (email + password have their own flows). Password change goes through
