    ...
    <div className="space-y-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {w.paymentStatus && (
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-blue-100 text-blue-600 border border-blue-100">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 space-y-2.5">
        ...
        {[["Customer Amt",w.customerAmount,"text-slate-800"],
          ...
          ["Total Payable",w.totalPayable,"text-blue-600 font-extrabold"],
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
          ...
          <div className="flex flex-wrap gap-1.5">
            {selectedServices.map(s=>(
              <span key={s} className="text-xs bg-blue-50 text-blue-600 border border-blue-100 px-2.5 py-1 rounded-full font-semibold">{s}</span>
            ))}
          </div>
        </div>
      )}
