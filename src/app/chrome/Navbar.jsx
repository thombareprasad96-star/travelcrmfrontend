...
// } from "lucide-react";
// import { notificationService } from "@features/reminders";
// import { companyService } from "@features/settings"; // 👉 company logo source
// import { getErrorMessage } from "@shared/api/apiError";
// import { toast } from "@shared/ui/toast";
...
//   // 👉 Company branding — drives the logo mark on the left of the bar.
//   const [company, setCompany] = useState(null);

//   // Loads the company once on mount, then again whenever the profile page announces a
//   // change. The custom event is what makes a fresh logo upload show up here without a
//   // page reload — CompanyProfile fires window.dispatchEvent(new Event("company-updated"))
//   // after a successful save.
//   useEffect(() => {
//     const loadCompany = () => {
//       // Navbar only ever renders behind auth, but guard anyway so a stray mount on the
//       // login screen doesn't fire an unauthenticated request.
...
//   // Tab title follows the tenant too.
//   useEffect(() => {
//     if (company?.name) document.title = `${company.name} — TravelCRM`;
//   }, [company?.name]);
