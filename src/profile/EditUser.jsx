...
// ─────────────────────────────────────────────────────────────
// Edit User Page — Travel CRM
// Matches CRM design system perfectly
// Reference: company/users/edit.php?id=34 screenshot
// Features:
//   - Username (read-only, cannot be changed)
//   - Email, Full Name, Phone, Role (editable)
//   - Account Status toggle (Active / Inactive)
//   - Current Permissions panel (Pages + Total badges, Manage button)
//   - Password Management toggle (set new password section)
//   - Account Information (Created, Last Updated, Last Login)
//   - Update User + Cancel + Manage Permissions action buttons
//   - Live sidebar preview
//   - Full validation + toast notifications
...
const MOCK_USERS = {
  "34": {
    id:34, username:"Shreyash_Shahi", fullName:"Shreyash Raghvendra Shahi",
    email:"nepaltours.travels@gmail.com", phone:"+91 90990 97103",
  ...
  "21": {
    id:21, username:"deepti_paul", fullName:"Deepti Paul",
    email:"pauldeepti74@gmail.com", phone:"+91 98765 00001",
    role:"Staff", status:"Active",
    permissions:{ pages:3, total:3 },
    createdAt:"May 30, 2026 10:00 AM",
    lastUpdated:"May 30, 2026 10:00 AM",
    lastLogin:"Never",
  },
  "20": {
    id:20, username:"vaishnavi_jagtap", fullName:"Vaishnavi Shrikant Jagtap",
    email:"vaishnavisjagtap00@gmail.com", phone:"+91 98765 00002",
    role:"Staff", status:"Active",
    permissions:{ pages:3, total:3 },
    createdAt:"May 30, 2026 10:00 AM",
    lastUpdated:"May 30, 2026 10:00 AM",
...
const avatarGrad = (id) => AVATAR_GRADS[Number(id||0) % AVATAR_GRADS.length];
...
export default function EditUser() {
  ...
  useEffect(()=>{
    setLoading(true);
    // BACKEND: userService.getById(id).then(res=>{ setUser(res.data); setForm({...}); }).finally(()=>setLoading(false));
    setTimeout(()=>{
      const u = MOCK_USERS[id] || MOCK_USERS["34"];
      setUser(u);
      setForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // BACKEND: await userService.update(id, payload);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <button type="button"
                          onClick={()=>showToast("Permissions management coming soon.","error")}
