// src/components/PermissionTemplates/PermissionTemplates.jsx
// ─────────────────────────────────────────────────────────────
// Permission Templates Page — Travel CRM
// Matches CRM design system perfectly
// Navigates to CreatePermissionTemplate for all creation flows
// ─────────────────────────────────────────────────────────────
...
export default function PermissionTemplates() {
  ...
  useEffect(() => {
    // BACKEND: permissionTemplateService.getAll().then(res => setTemplates(res.data)).finally(...)
  ...
  /* handlers */
  const handleDelete = () => {
    // BACKEND: permissionTemplateService.delete(deleteTarget.id).then(...)
  ...
  const handleDuplicate = (template) => {
    // BACKEND: permissionTemplateService.duplicate(template.id).then(...)
    const dup = {
      ...template,
      id:         Date.now(),
    ...
    showToast(`Template duplicated as "${dup.name}".`);
  };
