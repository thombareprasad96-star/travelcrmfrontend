// // src/components/Settings/WhatsAppConfiguration.jsx
// // ─────────────────────────────────────────────────────────────
// // WhatsApp Configuration Page — Travel CRM
// // Route: /Settings/WhatsApp
// // Matches CRM design system: glass cards, gradients, Plus Jakarta Sans
// // Reference: company/settings/whatsapp/index.php screenshot
// // Features:
// //   - WhatsApp Integration Settings card (Interakt)
// //     → API Key (masked + show/hide) | Template Name | Template Language | Header Image URL
// //     → Template Format Information info panel (blue left border)
// //     → Save Configuration button
// //   - Test WhatsApp Integration card
// //     → +91 prefix phone input | Send Test Message button
// //   - Right sidebar:
// //     → Setup Guide steps (1-4 with icons)
// //     → Quick Stats (messages sent / delivery rate / last tested)
...
//     setSaving(true);
//     try {
//       // BACKEND: await whatsAppConfigService.saveConfig(form);
...
//     try {
//       // BACKEND: await whatsAppConfigService.sendTestMessage(testPhone);
//       await new Promise(r => setTimeout(r, 1800));
//       setTestResult({ type: "success", msg: `Test message sent successfully to +91${testPhone}` });
//     } catch (err) {
...
//                 {[
//                   { label:"Messages Sent", value:"128",          sub:"This month",         color:"text-green-600" },
//                   { label:"Delivery Rate", value:"98%",          sub:"Last 30 days",       color:"text-blue-600"  },
//                   { label:"Last Tested",   value:"Jun 25, 2026", sub:"Test was successful", color:"text-teal-600"  },
//                   { label:"API Status",    value:"Active",       sub:"Connected",           color:"text-emerald-600"},
//                 ].map((s, i) => (
//                   <div key={s.label}
