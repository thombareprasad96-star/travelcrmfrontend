...
// src/components/Bookings/BookingsPage.jsx
// ─────────────────────────────────────────────────────────────
// All Bookings Page — Travel CRM (Fully Enhanced)
// Matches CRM design system exactly (same as BookingRevenueAnalysis,
// VendorsPage, LeadLogs, Dashboard etc.)
// Design tokens:
//   bg: from-slate-50 via-blue-50/30 to-slate-100
//   cards: bg-white/80 backdrop-blur-md rounded-2xl border border-slate-200/60
//   filter header: bg-slate-600 (collapsible dark slate, same as Reports)
