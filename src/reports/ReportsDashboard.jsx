...
// // ─────────────────────────────────────────────────────────────
// // Reports Dashboard Page — Travel CRM
...
// // Reference: company/reports/index.php screenshot
// // 6 report cards:
// //   1. Activity Reports        (blue)
// //   2. Geographic Distribution (green)
// //   3. Follow-up Reports       (amber)
// //   4. Booking Revenue Analysis(green)
// //   5. Travel Date Analysis    (green)
// //   6. International vs Domestic(blue)
// // Features:
// //   - Stat summary cards at top
// //   - 6 report category cards in 3-col grid (responsive)
// //   - Each card: icon + title + description + View Reports button
...
//   useEffect(()=>{
//     // BACKEND: reportService.getSummary(activeFilter).then(...).finally(...)
...
//   const handleRefresh = () => {
//     setLoading(true);
//     setTimeout(()=>{ setLoading(false); showToast("Reports refreshed."); }, 800);
//   };
