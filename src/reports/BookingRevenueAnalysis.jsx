...
// // Reference: company/reports/booking_revenue.php screenshot
// // Features:
// //   - Collapsible Filters & Settings (dark slate header)
// //   - Start Date / End Date / Date Type / Status / Payment Status / Apply
// //   - Min Amount / Max Amount / Reset / Export CSV
// //   - 4 large stat cards: Total Revenue | Net Profit | Avg Net Margin | Outstanding Due
// //   - Revenue Breakdown panel: TCS | Total Payable | Paid Amount | Refunded
// //   - Booking Statistics panel: International | Domestic | Confirmed | Completed | Cancelled
// //   - Booking Details table:
// //       Booking Code | Customer | Customer Amount | TCS | Total Payable | Paid/Due | Vendor Cost | Net Profit | Net Margin% | Type | Status | Travel Date | Actions
