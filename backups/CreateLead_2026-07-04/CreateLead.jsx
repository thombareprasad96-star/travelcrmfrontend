        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="relative w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-200 flex-shrink-0 overflow-hidden">
                <div className="absolute inset-x-0 -top-1/2 h-full bg-gradient-to-b from-white/25 to-transparent opacity-60"/>
                <FiFileText className="relative w-5 h-5 text-white" />
              </div>
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl font-extrabold text-slate-800 tracking-tight">Create New Lead</h1>
            ...
            <button onClick={() => navigate("/allleads")}
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 hover:border-blue-300
                text-sm font-semibold text-slate-600 hover:text-blue-600 bg-white hover:bg-blue-50 transition-all shadow-sm w-full sm:w-auto"
            >
              <FiArrowLeft className="w-4 h-4" />
              Back to Leads
            </button>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden fade-up">
                <div className="relative bg-gradient-to-r from-amber-500 to-orange-400 px-6 py-4 flex items-center gap-3 overflow-hidden">
                  ...
                  <div className="relative w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center shadow-inner">
                    <FiFileText className="w-4 h-4 text-white" />
                  </div>
              ...
              <div className="sticky bottom-4 z-20 bg-white/90 backdrop-blur-md rounded-2xl shadow-lg shadow-slate-200/60 border border-slate-200/70 p-4 sm:p-5">
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  <button
                    type="button"
                    onClick={onSaveDraft}
                  ...
                  <button
                    ...
                    disabled={submitting || savingDraft}
                    className="w-full sm:flex-1 flex items-center justify-center gap-2.5 px-8 py-3 rounded-xl
                      bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 active:scale-[0.99] text-white font-bold text-sm
                      transition-all shadow-md shadow-blue-200 hover:shadow-lg hover:shadow-blue-300
                      disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {submitting ? (
